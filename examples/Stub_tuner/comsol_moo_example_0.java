...
public class comsol_moo_example_0 {
  ...
  public static Model run() {
    ...
    model.param().set("R_tube", "4[mm]");
    model.param().set("R_tube_od", "5[mm]");
    model.param().set("R_major", "20[mm]");
    model.param().set("f_sup", "2.45[GHz]");
    model.param().set("L_slide", "200[mm]");
    model.param().set("L_stub1", "3.0[mm]");
    model.param().set("L_stub2", "3.0[mm]");
    model.param().set("L_stub3", "20.0[mm]");
    model.param().set("P_supply", "200.0[W]");
    model.param().set("T0", "303.15[K]");
    model.param().set("U_in", "0.005[m/s]");
    ...
    model.component("comp1").variable("var1")
         .set("rho", "838.466135 + 1.40050603[1/K] * T - 0.0030112376 [1/K^2]* (T^2) + 3.71822313e-7[1/K^3] * (T^3)");
    model.component("comp1").variable("var1")
         .set("Cp", "12010.1471 - 80.4072879[1/K] * T + 0.309866854 [1/K^2]* (T^2) - 5.38186884e-4 [1/K^3]* (T^3) + 3.62536437e-7 [1/K^4]* (T^4)");
    model.component("comp1").variable("var1")
         .set("eff", "pi*(R_tube)^2*U_in*(rho*Cp*T - 998.21*4184.44*T0)/P_supply * 100[J/m^3/K]");
    ...
    model.component("comp1").physics("ht").feature("ofl1").selection().set(56);
    model.component("comp1").physics("ht").create("temp1", "TemperatureBoundary", 2);
    model.component("comp1").physics("ht").feature("temp1").selection().set(49);
    ...
    model.component("comp1").physics("spf").feature("inl1").selection().set(49);
    model.component("comp1").physics("spf").create("out1", "OutletBoundary", 2);
    model.component("comp1").physics("spf").feature("out1").selection().set(56);
    ...
    model.component("comp1").physics("ht").feature("hs1").set("Q0_src", "root.comp1.emw.Qe");

    model.study().create("std1");
    model.study("std1").create("freq", "Frequency");
    model.study("std1").create("time", "Transient");
    model.study("std1").feature("freq")
         .set("activate", new String[]{"emw", "on", "ht", "off", "spf", "off", "frame:spatial1", "on"});
    model.study("std1").feature("freq").set("activateCoupling", new String[]{"emh1", "on", "nitf1", "off"});
    model.study("std1").feature("time")
         .set("activate", new String[]{"emw", "off", "ht", "on", "spf", "on", "frame:spatial1", "on"});
  ...
  public static Model run2(Model model) {
    ...
    model.study("std1").feature("time").set("tlist", "range(0,1,40)");

    model.sol("sol1").attach("std1");
    model.sol("sol1").feature("v1").set("clistctrl", new String[]{"p1", "t1_timestep"});
    model.sol("sol1").feature("v1").set("cname", new String[]{"freq", "timestep"});
    model.sol("sol1").feature("v1").set("clist", new String[]{"2.45[GHz]", "0.05[s]"});
    model.sol("sol1").feature("s1").set("stol", 0.01);
    model.sol("sol1").feature("s1").feature("aDef").set("complexfun", true);
    model.sol("sol1").feature("s1").feature("p1").set("pname", new String[]{"freq"});
    model.sol("sol1").feature("s1").feature("p1").set("plistarr", new String[]{"2.45[GHz]"});
    ...
    model.sol("sol1").feature("t1")
         .set("atolmethod", new String[]{"comp1_E", "global", "comp1_p", "scaled", "comp1_T", "global", "comp1_u", "global", "comp1_Sparam1", "global"});
    model.sol("sol1").feature("t1")
         .set("atolfactor", new String[]{"comp1_E", "0.1", "comp1_p", "1", "comp1_T", "0.1", "comp1_u", "0.1", "comp1_Sparam1", "0.1"});
    ...
    model.result().numerical("av1").selection().set(56);
    model.result().numerical("av1").set("looplevelinput", new String[]{"last"});
    model.result().numerical("av1").set("table", "tbl1");
    model.result().numerical("av1").set("expr", new String[]{"T", "eff"});
    model.result().numerical("av1").set("unit", new String[]{"K", "1"});
    model.result().numerical("av1").set("descr", new String[]{"Temperature", ""});
